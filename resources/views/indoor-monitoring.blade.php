...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 ml-3 mb-1 text-gray-800">Monitor Dalam</h1>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h3 mb-0 font-weight-bold text-gray-800">
                                <span id="indoor-dose-rate">{{ trim(json_encode($latestData->original['usvh']),'"') }}</span>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h3 mb-0 font-weight-bold text-gray-800">
                                <span id="indoor-temperature">{{ trim(json_encode($latestData->original['suhu']),'"') }}</span>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h3 mb-0 font-weight-bold text-gray-800">
                                <span id="indoor-humidity">{{ trim(json_encode($latestData->original['kelembapan']),'"') }}</span>
                                <sup class="font-weight-normal">%</sup>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card shadow">
                <div class="card-body py-3">
                    <div class="d-flex align-items-center flex-wrap">
                        ...
                        <select id="indoor-time-range" class="form-control form-control-sm mr-2" style="width:200px;">
                        ...
                        <input type="date" id="indoor-custom-date"
                               class="form-control form-control-sm mr-2 d-none" style="width:160px;">
                        <span id="indoor-live-indicator" class="badge badge-success">
    ...
    <div class="row">
        <div class="col-xl-6 col-lg-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div id="indoor-dose-rate-chart"></div>
                </div>
            </div>
        </div>
        <div class="col-xl-6 col-lg-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div id="indoor-temperature-chart"></div>
                </div>
            </div>
        </div>
        <div class="col-xl-6 col-lg-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div id="indoor-humidity-chart"></div>
                </div>
            </div>
        </div>
    </div>
