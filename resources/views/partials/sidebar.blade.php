...
<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
        ...
        <div class="sidebar-brand-text mx-3">Monitor Radiasi Area</div>
    </a>
    ...
    <li class="nav-item {{ Request::is('outdoor-monitor') || Request::is('indoor-monitor') ? 'active' : '' }}">
        ...
        <div id="collapseTwo" class="collapse {{ Request::is('outdoor-monitor') || Request::is('indoor-monitor') ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item {{ Request::is('outdoor-monitor') ? 'active' : '' }}" href="/outdoor-monitor">Monitor Luar</a>
            </div>
        </div>
    </li>

    <!-- Nav Item - Utilities Collapse Menu -->
    <li class="nav-item {{ Request::is('outdoor-monitor-data-tables') || Request::is('indoor-monitor-data-tables') || Request::is('integrity-data-tables') ? 'active' : '' }}">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
            aria-expanded="true" aria-controls="collapseUtilities">
            <i class="fas fa-fw fa-table"></i>
            <span style="font-size: 1rem">Data Tables</span>
        </a>
        <div id="collapseUtilities" class="collapse {{ Request::is('outdoor-monitor-data-tables') || Request::is('indoor-monitor-data-tables') || Request::is('integrity-data-tables') ? 'show' : '' }}" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item {{ Request::is('outdoor-monitor-data-tables') ? 'active' : '' }}" href="/outdoor-monitor-data-tables">Monitor Luar</a>
                <a class="collapse-item {{ Request::is('integrity-data-tables') ? 'active' : '' }}" href="/integrity-data-tables">Log Kualitas Jaringan</a>
            </div>
        </div>
    </li>
